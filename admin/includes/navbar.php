...
<li class="nav-item">
  <a class="nav-link" href="viewCustomOrders.php">
...
<li class="nav-item">
  <a class="nav-link" href="airline.php">
    <i class="fas fa-calculator"></i>
    <span>Add Airline</span></a>
</li>

<li class="nav-item">
  <a class="nav-link" href="view_airline.php">
    <i class="fas fa-calculator"></i>
    <span>View Airline</span></a>
</li>

<li class="nav-item">
  <a class="nav-link" href="airline_bookings.php">
    <i class="fas fa-calculator"></i>
    <span>Airline Booking</span></a>
</li>
...
<li class="nav-item">
  <a class="nav-link" href="view_bus.php">
    <i class="fas fa-calculator"></i>
    <span>View Bus</span></a>
</li>

<li class="nav-item">
  <a class="nav-link" href="bus_bookings.php">
    <i class="fas fa-calculator"></i>
