...
if(isset($_POST['upload'])){
  ...
  $sqlQuery = "INSERT INTO `vender_packages`(`packageName`, `packagePrice`, `packageImage`, `packageCategory`, `packageDescription`) VALUES ('$packageName','$packagePrice','$imageDes','$packageCategory','$packageDescription');";
  ...
  if($query){
    ...
    <script>
    alert('Invalid Input')
    window.location.href='addPackages.php';
    </script>
    ";
}
...
<div class="card shadow mb-4">
  ...
  <div class="mb-3">
    ...
    <select class="form-select" name="packageCategory">
      ...
      <option value="Economic Packages">Economic Packages</option>
      <option value="Hotel Packages">Hotel Packages</option>
      <option value="Car Packages">Car Packages</option>
      <option value="Farm Packages">Farm Packages</option>
    </select>
  </div>
  <div class="mb-3">
