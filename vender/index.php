      ...
      <div class="card border-left-primary shadow h-100 py-5">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="font-weight-bold text-primary text-uppercase mb-1">Orders</div>
            ...
            <div class="col mr-2">
              ...
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
                  ...
                  <?php
                include 'config.php';
                $sqlQuery = "SELECT id FROM vender_packages ORDER by id";
                $query = mysqli_query($con,$sqlQuery);
                $row = mysqli_num_rows($query);
                echo "<h1>$row</h1>"
                ?>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <?php
                include 'config.php';
                $sqlQuery = "SELECT DISTINCT packageCategory FROM vender_packages";
                $query = mysqli_query($con,$sqlQuery);
                $row = mysqli_num_rows($query);
                echo "<h1>$row</h1>"
                ?>
