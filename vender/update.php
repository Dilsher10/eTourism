...
<body>
  ...
  <div class="mb-3">
    ...
    <select class="form-select" name="packageCategory">
      <option value="luxuryPackages">Luxury Packages</option>
      <option value="economicPackages">Economic Packages</option>
      <option value="hotelPackages">Hotel Packages</option>
      <option value="carPackages">Car Packages</option>
    </select>
  </div>
